...
awshost = "atqc2417znrxp-ats.iot.ap-northeast-2.amazonaws.com"      # Endpoint
awsport = 8883                                              # Port no.
clientId = "raspberryPi"                                     # Thing_Name
thingName = "raspberryPi"                                    # Thing_Name
caPath = "certs/RootCA1.pem"                                      # Root_CA_Certificate_Name
certPath = "certs/raspberryPi-certificate.pem.crt"                            # <Thing_Name>.cert.pem
keyPath = "certs/raspberryPi-private.pem.key"                          # <Thing_Name>.private.key
...
while i > 0:
    sleep(2)
    if connflag == True:
        mqttc.publish("raspberryPi", "0", qos=1)        # topic:  # Publishing  values
        print("msg sent: onoff -> off") # Print sent msg on console
    else:
